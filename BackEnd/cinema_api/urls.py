...
from .views import api_root, CineList, CineDetail, CiudadList, CiudadDetail, GeneroList, GeneroDetail, PeliculaList, PeliculaDetail, ProductoList, ProductoDetail, SalaList, SalaDetail, TiendaList, TiendaDetail
